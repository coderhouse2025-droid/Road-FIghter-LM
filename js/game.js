...
const ZONES=[
  {name:'LA MATANZA',sky:'#6ad4f0',grass:'#4a8a10',road:'#808080',line:'#fff',dist:0},
  {name:'LINIERS',   sky:'#5ab8e0',grass:'#3a7010',road:'#787878',line:'#ffd700',dist:500},
  {name:'CABALLITO', sky:'#4aa0d0',grass:'#2a6030',road:'#888',   line:'#ff8800',dist:1000},
  {name:'PALERMO',   sky:'#3a88c0',grass:'#1a5040',road:'#909090',line:'#fff',   dist:1500},
  {name:'RETIRO',    sky:'#2a6090',grass:'#0a3050',road:'#707070',line:'#0cf',   dist:2000},
];
...
function startGame(){
  ...
  fc=0;lt=null;dtimer=0;co=0;ct=0;fwt=0;lfws=0;
...
function upd(dt){
  ...
  if(oils.length<1&&Math.random()<0.0007)spawnO();
...
// ================================================================
function draw(){
  drawSky();drawGrass();drawRoad();drawScenery();
